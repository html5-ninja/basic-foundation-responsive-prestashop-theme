...
<form action="{$link->getPageLink('authentication', true)}" method="post" id="create-account_form" class="std ">
    <fieldset>
        ...
        <div class="form_content clearfix">
            ...
            <input type="button" id="SubmitCreate" name="SubmitCreate" class="button" value="{l s='Create your account'}" />
        ...
        <fieldset>
            ...
            <div id="opc_account_form" style="display: block; ">
                ...
                {if isset($newsletter) && $newsletter}
                    ...
                    <p class="checkbox"><label for="optin">
...
{else}
    ...
    {/if}-->
        <form action="{$link->getPageLink('authentication', true)}" method="post" id="account-creation_form-x" class="std ">
            ...
            <span class="right"><sup>*</sup>{l s='Required field'}</span>
        </p>
    </form>
    {/if}