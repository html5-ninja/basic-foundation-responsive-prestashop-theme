...
<div id="order-detail-content" class="table_block">
    <table id="cart_summary" class="responsive twelve">
		<thead>
			<tr>
...
{if !$opc}
	<p class="cart_navigation"><a href="{$link->getPageLink('order', true, NULL, "step=2")}" title="{l s='Previous'}">&laquo; {l s='Previous'}</a></p>
{else}
	</div>
{/if}
</div>
