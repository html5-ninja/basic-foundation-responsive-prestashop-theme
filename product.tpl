...
{if $errors|@count == 0}
    ...
    <div id="primary_block" class="clearfix twelve columns">
        ...
        <div class="row">
            <!-- right infos-->
            <div  class="five columns pb-right-column">
                <!-- product img-->
                <div id="image-block">
                    {if $have_image}
                        <span id="view_full_size" class="th">
                            ...
                            <span class="span_link zoom"><i class="foundicon-photo"></i></span>
                        </span>
                    {else}
                        <span id="view_full_size" class="th">
...
<!-- left infos-->
<div class="seven columns pb-left-column">
    ...
    {if $product->description_short OR $packItems|@count > 0}
        <div id="short_description_block">
            ...
            {if $product->description}
                <p class="buttons_bottom_block"><a href="javascript:{ldelim}{rdelim}" class="button tiny">{l s='More details'}</a></p>
            {/if}
                        ...
                        {foreach from=$groups key=id_attribute_group item=group}
                            {if $group.attributes|@count}
                                <fieldset class="attribute_fieldset">
                                    <legend>{$group.name|escape:'htmlall':'UTF-8'}</legend>
                                    {assign var="groupName" value="group_$id_attribute_group"}
                                    <div class="attribute_list">
                                        {if ($group.group_type == 'select')}
                                            <select style="display: none" name="{$groupName}" id="group_{$id_attribute_group|intval}" class="attribute_select" onchange="findCombination();getProductAttribute();{if $colors|@count > 0}$('#wrapResetImages').show('slow');{/if};">
...
{else}
    <p id="add_to_cart" class="buttons_bottom_block">
        <input type="submit" name="Submit" value="{l s='Add to cart'}" class="button small" />
    </p>
{/if}
...
{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
    <div id="more_info_block" class="clear">
        <dl class="sub-nav">  
        {if $product->description}<dd class="active"><a id="more_info_tab_more_info" href="#idTab1">{l s='More info'}</a></dd>{/if}
    {if $features}<dd><a id="more_info_tab_data_sheet" href="#idTab2">{l s='Data sheet'}</a></dd>{/if}
{if $attachments}<dd><a id="more_info_tab_attachments" href="#idTab9">{l s='Download'}</a></dd>{/if}
{if isset($accessories) AND $accessories}<dd><a href="#idTab4">{l s='Accessories'}</a></dd>{/if}
{if isset($product) && $product->customizable}<dd><a href="#idTab10">{l s='Product customization'}</a></dd>{/if}
{$HOOK_PRODUCT_TAB}
</dl>
